...
public class ClassMetrics {
	...
	public static boolean isJdkClass(String s) {
		return (s.startsWith("java.") || s.startsWith("javax.") || s.startsWith("org.omg.")
				|| s.startsWith("org.w3c.dom.") || s.startsWith("org.xml.sax."));
	}

	/** Return the 6 CK metrics plus Ce as a space-separated string */
	public String toString() {
		return (wmc + " " + getDit() + " " + noc + " " + cbo + " " + rfc + " " + lcom + " " + getCa() + " " + npm);
	}
